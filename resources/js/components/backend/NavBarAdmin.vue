<script setup>
    ...
    import NavBarElement from "@/components/backend/navBarElement.vue";
    ...
    <nav class="sticky top-0 left-0 min-w-[185px] w-[calc(15vw)] 3xl:w-1/10 flex flex-col bg-surface h-screen shadow p-6">
        ...
        <div class="w-full flex flex-grow flex-col justify-between items-center">
            <div class="w-full flex flex-col gap-8 items-center py-8">
                <NavBarElement icon-name="rectangleGroup" label="Dashboard" page-name="admin/Dashboard" route-name="admin.dashboard" />

                <NavBarElement icon-name="userGroup" label="Users" page-name="admin/users/Index" route-name="users.index" />
